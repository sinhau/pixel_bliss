...
class TrendingTopicsProvider:
    ...
    def get_trending_theme(self, progress_logger=None) -> str:
        """
        Get a trending theme recommendation based on current web trends.
        ...
        try:
            ...
            self.logger.info("Fetching trending topics and generating theme recommendation")
            ...
            response = self.client.chat.completions.create(
                ...
                tools=[{"type": "web_search"}] if hasattr(self.client, 'tools') else None
            )
